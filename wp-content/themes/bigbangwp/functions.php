...
function remove_old_version_of_multiple_thumbnail() {
		$multiple_url = "http://localhost/WordPressSabloni/Bigbang/WordPress/wp-content/plugins/multiple-post-thumbnails/multi-post-thumbnails.php";
...
// version 2.0
include_once( TEMPLATEPATH . '/includes/inc2.0/class-tgm-plugin-activation.php' );
